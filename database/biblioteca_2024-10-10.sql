  ...
  CREATE TABLE `usuarios` (
    ...
    `Tipo` enum('admin','bibliotecario','usuario') NOT NULL DEFAULT 'usuario',
...
(1, 'João Silva Santos', '2001-04-01', '(81) 98788-2311', 'joao.silva@gmail.com', 631113101, 'Rua Boa Esperança', '201', 'Janga', 'Paulista/PE'),
